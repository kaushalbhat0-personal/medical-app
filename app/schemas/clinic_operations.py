...
class ProcurementPendingItem(BaseModel):
    """A purchase order awaiting action."""
...
class ClinicOperationsDashboard(BaseModel):
    ...
    procurement_pending: list[ProcurementPendingItem] = Field(default_factory=list)
